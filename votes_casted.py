...
def speak(str1):     #conversion from text to speech eg: your vote has been recorded
...
while True:          
    ...
    for (x, y, w, h) in faces:
        ...
        aadhar = str(output[0])
        cv2.putText(frame, aadhar, (x, y-15), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1)
    

    # imgBackground[370:370 + 480, 225:225 + 640 ] = frame    
    # imgBackground[70:550, 80:720, :] = frame
    # imgBackground[78:558, 80:720, :] = frame
    # imgBackground[86:566, 80:720, :] = frame
    # imgBackground[94:574, 80:720, :] = frame
    # imgBackground[100:580, 80:720, :] = frame

    # imgBackground[30:510, 80:720, :] = frame
